...
export class BootScene extends Phaser.Scene {
  ...
  public preload(): void {
    this.load.image("town-v2", `${import.meta.env.BASE_URL}assets/v2/town-no-flags.png`);
    this.load.image("town-south", `${import.meta.env.BASE_URL}assets/v2/town-south-memory.png`);
